...
INSERT INTO categories(id, name) VALUES (1, 'Прогулка');
INSERT INTO categories(id, name) VALUES (2, 'Пробежка');
INSERT INTO categories(id, name) VALUES (3, 'Велосипед');
INSERT INTO categories(id, name) VALUES (4, 'Самокат');
INSERT INTO categories(id, name) VALUES (5, 'Ролики');
INSERT INTO categories(id, name) VALUES (6, 'С питомцем');
INSERT INTO categories(id, name) VALUES (7, 'Утренняя прогулка');
INSERT INTO categories(id, name) VALUES (8, 'Вечерний маршрут');
INSERT INTO categories(id, name) VALUES (9, 'Ночной маршрут');
INSERT INTO categories(id, name) VALUES (10, 'По заповеднику');
INSERT INTO categories(id, name) VALUES (11, 'По набережной');
INSERT INTO categories(id, name) VALUES (12, 'По стрит-арту');
INSERT INTO categories(id, name) VALUES (13, 'По достопримечательностям');

INSERT INTO routes(id, name, difficulty, distance, duration, likes, created_at, description)
    VALUES (1, 'Маршрут #1', 'EASY', 1600, 40, 50, CURRENT_TIMESTAMP, 'Duis eget risus mi. Sed tincidunt lobortis dolor sit amet suscipit. Donec accumsan quis turpis at placerat. Maecenas id magna vel mi viverra eleifend vitae eu arcu. Nunc pulvinar odio a velit facilisis posuere. Quisque sodales sapien sed tortor efficitur, a mattis metus mattis. Aliquam eleifend lectus ut nibh hendrerit, vitae vulputate magna pellentesque. Praesent risus nisl, iaculis ut convallis non, vestibulum nec arcu. Praesent mattis ullamcorper odio, sed aliquam sapien porta vitae. Nulla molestie aliquam arcu at laoreet. Ut vitae velit eget lorem auctor dictum. Vestibulum turpis orci, dignissim et neque sit amet, feugiat facilisis diam. Aliquam est risus, rhoncus non pharetra at, lobortis quis odio. Morbi in ornare mauris.');
INSERT INTO routes(id, name, difficulty, distance, duration, likes, created_at, description)
    VALUES (2, 'Маршрут #2', 'MEDIUM', 2600, 60, 100, CURRENT_TIMESTAMP, 'Duis eget risus mi. Sed tincidunt lobortis dolor sit amet suscipit. Donec accumsan quis turpis at placerat. Maecenas id magna vel mi viverra eleifend vitae eu arcu. Nunc pulvinar odio a velit facilisis posuere. Quisque sodales sapien sed tortor efficitur, a mattis metus mattis. Aliquam eleifend lectus ut nibh hendrerit, vitae vulputate magna pellentesque. Praesent risus nisl, iaculis ut convallis non, vestibulum nec arcu. Praesent mattis ullamcorper odio, sed aliquam sapien porta vitae. Nulla molestie aliquam arcu at laoreet. Ut vitae velit eget lorem auctor dictum. Vestibulum turpis orci, dignissim et neque sit amet, feugiat facilisis diam. Aliquam est risus, rhoncus non pharetra at, lobortis quis odio. Morbi in ornare mauris.');
INSERT INTO routes(id, name, difficulty, distance, duration, likes, created_at, description)
    VALUES (3, 'Маршрут #3', 'HARD', 3600, 80, 150, CURRENT_TIMESTAMP, 'Duis eget risus mi. Sed tincidunt lobortis dolor sit amet suscipit. Donec accumsan quis turpis at placerat. Maecenas id magna vel mi viverra eleifend vitae eu arcu. Nunc pulvinar odio a velit facilisis posuere. Quisque sodales sapien sed tortor efficitur, a mattis metus mattis. Aliquam eleifend lectus ut nibh hendrerit, vitae vulputate magna pellentesque. Praesent risus nisl, iaculis ut convallis non, vestibulum nec arcu. Praesent mattis ullamcorper odio, sed aliquam sapien porta vitae. Nulla molestie aliquam arcu at laoreet. Ut vitae velit eget lorem auctor dictum. Vestibulum turpis orci, dignissim et neque sit amet, feugiat facilisis diam. Aliquam est risus, rhoncus non pharetra at, lobortis quis odio. Morbi in ornare mauris.');
INSERT INTO routes(id, name, difficulty, distance, duration, likes, created_at, description)
    VALUES (4, 'Маршрут #4', 'EASY', 1200, 30, 30, CURRENT_TIMESTAMP, 'Duis eget risus mi. Sed tincidunt lobortis dolor sit amet suscipit. Donec accumsan quis turpis at placerat. Maecenas id magna vel mi viverra eleifend vitae eu arcu. Nunc pulvinar odio a velit facilisis posuere. Quisque sodales sapien sed tortor efficitur, a mattis metus mattis. Aliquam eleifend lectus ut nibh hendrerit, vitae vulputate magna pellentesque. Praesent risus nisl, iaculis ut convallis non, vestibulum nec arcu. Praesent mattis ullamcorper odio, sed aliquam sapien porta vitae. Nulla molestie aliquam arcu at laoreet. Ut vitae velit eget lorem auctor dictum. Vestibulum turpis orci, dignissim et neque sit amet, feugiat facilisis diam. Aliquam est risus, rhoncus non pharetra at, lobortis quis odio. Morbi in ornare mauris.');
INSERT INTO routes(id, name, difficulty, distance, duration, likes, created_at, description)
    VALUES (5, 'Маршрут #5', 'MEDIUM', 2200, 50, 60, CURRENT_TIMESTAMP, 'Duis eget risus mi. Sed tincidunt lobortis dolor sit amet suscipit. Donec accumsan quis turpis at placerat. Maecenas id magna vel mi viverra eleifend vitae eu arcu. Nunc pulvinar odio a velit facilisis posuere. Quisque sodales sapien sed tortor efficitur, a mattis metus mattis. Aliquam eleifend lectus ut nibh hendrerit, vitae vulputate magna pellentesque. Praesent risus nisl, iaculis ut convallis non, vestibulum nec arcu. Praesent mattis ullamcorper odio, sed aliquam sapien porta vitae. Nulla molestie aliquam arcu at laoreet. Ut vitae velit eget lorem auctor dictum. Vestibulum turpis orci, dignissim et neque sit amet, feugiat facilisis diam. Aliquam est risus, rhoncus non pharetra at, lobortis quis odio. Morbi in ornare mauris.');
INSERT INTO routes(id, name, difficulty, distance, duration, likes, created_at, description)
    VALUES (6, 'Маршрут #6', 'HARD', 3200, 70, 90, CURRENT_TIMESTAMP, 'Duis eget risus mi. Sed tincidunt lobortis dolor sit amet suscipit. Donec accumsan quis turpis at placerat. Maecenas id magna vel mi viverra eleifend vitae eu arcu. Nunc pulvinar odio a velit facilisis posuere. Quisque sodales sapien sed tortor efficitur, a mattis metus mattis. Aliquam eleifend lectus ut nibh hendrerit, vitae vulputate magna pellentesque. Praesent risus nisl, iaculis ut convallis non, vestibulum nec arcu. Praesent mattis ullamcorper odio, sed aliquam sapien porta vitae. Nulla molestie aliquam arcu at laoreet. Ut vitae velit eget lorem auctor dictum. Vestibulum turpis orci, dignissim et neque sit amet, feugiat facilisis diam. Aliquam est risus, rhoncus non pharetra at, lobortis quis odio. Morbi in ornare mauris.');
